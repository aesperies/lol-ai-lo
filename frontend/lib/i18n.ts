...
const es = {
  ...
  // Client dashboard — metric cards, SLA deadlines & activity (Roadmap D)
  "dashboard.stats.inProgress": "En curso",
  "dashboard.stats.awaitingYou": "Esperando tu revisión",
  "dashboard.stats.inCounselReview": "En validación",
  "dashboard.stats.ready": "Listas para descargar",
  "dashboard.stats.deliveredThisMonth": "{n} entregadas este mes",
  "dashboard.stats.avgValidation": "media de validación: {hours} h",
  "dashboard.deadlines.title": "Vencimientos de validación",
  "dashboard.deadlines.subtitle":
    "Revisiones de abogado en curso y su plazo SLA de {sla} h.",
  "dashboard.deadlines.hoursLeft": "{hours} h restantes",
  "dashboard.deadlines.overdue": "VENCIDA",
  ...
  "dashboard.activity.action.params_confirmed": "Parámetros confirmados",
  "dashboard.activity.action.document_generated": "Documento generado",
  "dashboard.activity.action.counsel_requested": "Enviado a revisión de abogado",
  "dashboard.activity.action.counsel_comment_added": "Comentario del abogado",
  "dashboard.activity.action.document_validated": "Documento validado por el abogado",
  "dashboard.activity.action.draft_downloaded": "Borrador descargado",
  "dashboard.activity.action.final_downloaded": "Documento final descargado",
  "dashboard.activity.action.exit_a_acknowledged": "Entrega directa aceptada",
  "dashboard.activity.action.precedent_uploaded": "Precedente subido",
  "dashboard.activity.action.fund_created": "Fondo creado",
  ...
  "intake.vehicle": "Vehículo / SPV (opcional)",
  "intake.vehiclePlaceholder": "Sin vehículo — el fondo directamente",
  ...
  // Urgencia SLA calculada por el backend (verde · ámbar · rojo)
  "counsel.urgency.green": "En plazo",
  "counsel.urgency.amber": "Mitad de SLA",
  "counsel.urgency.red": "SLA vencido",
  "counsel.urgency.hours": "{hours} h de {sla} h",
  "counsel.pending": "{n} pendientes ({overdue} vencidas)",
  "counsel.filterGestora": "Gestora",
  "counsel.filterUrgency": "Urgencia",
  "counsel.allGestoras": "Todas las gestoras",
  "counsel.allUrgencies": "Todas las urgencias",
  // Assignment policy sections: own gestoras vs. unassigned pool.
  "counsel.sections.mine": "Mis gestoras",
  "counsel.sections.pool": "Nuevas gestoras sin abogado asignado",
  "counsel.sections.poolHint":
    "Cualquier abogado puede atender estas revisiones hasta que se les asigne uno.",
  "counsel.sections.poolBadge": "Sin abogado asignado",
  ...
  "notifications.minutesAgo": "hace {m} min",
  "notifications.hoursAgo": "hace {h} h",
  "notifications.daysAgo": "hace {d} días",
  ...
  // Funds & vehicles (SPVs) — /funds (015_vehicles.sql)
  "funds.title": "Mis fondos",
  "funds.subtitle":
    "Fondos y vehículos (SPVs) de tu gestora sobre los que solicitar documentos.",
  "funds.new": "Nuevo fondo",
  "funds.name": "Nombre del fondo",
  "funds.jurisdiction": "Jurisdicción",
  "funds.create": "Crear fondo",
  "funds.empty": "Aún no hay fondos. Crea el primero.",
  "funds.vehicles": "Vehículos / SPVs",
  "funds.vehicleCount": "{count} vehículos",
  "funds.vehicleCountOne": "1 vehículo",
  "funds.noVehicles": "Este fondo aún no tiene vehículos.",
  ...
  "funds.delete": "Eliminar",
  "funds.confirmDelete": "¿Eliminar definitivamente?",
  "funds.confirmDeleteYes": "Sí, eliminar",
  "funds.vehicleType.spv": "SPV",
  "funds.vehicleType.feeder": "Feeder",
  "funds.vehicleType.coinvest": "Coinversión",
  "funds.vehicleType.holdco": "Holding",
  "funds.vehicleType.other": "Otro",
} as const;
...
const en: Record<DictKey, string> = {
  ...
  "dashboard.stats.awaitingYou": "Awaiting your review",
  "dashboard.stats.inCounselReview": "In counsel validation",
  "dashboard.stats.ready": "Ready to download",
  "dashboard.stats.deliveredThisMonth": "{n} delivered this month",
  "dashboard.stats.avgValidation": "avg. validation: {hours} h",
  "dashboard.deadlines.title": "Validation deadlines",
  "dashboard.deadlines.subtitle":
    "Counsel reviews in progress and their {sla} h SLA.",
  "dashboard.deadlines.hoursLeft": "{hours} h left",
  "dashboard.deadlines.overdue": "OVERDUE",
  ...
  "dashboard.activity.action.counsel_requested": "Sent to counsel review",
  "dashboard.activity.action.counsel_comment_added": "Counsel comment",
  "dashboard.activity.action.document_validated": "Document validated by counsel",
  "dashboard.activity.action.draft_downloaded": "Draft downloaded",
  "dashboard.activity.action.final_downloaded": "Final document downloaded",
  "dashboard.activity.action.exit_a_acknowledged": "Direct delivery accepted",
  "dashboard.activity.action.precedent_uploaded": "Precedent uploaded",
  "dashboard.activity.action.fund_created": "Fund created",
  ...
  "intake.vehicle": "Vehicle / SPV (optional)",
  "intake.vehiclePlaceholder": "No vehicle — the fund directly",
  ...
  "counsel.urgency.green": "On time",
  "counsel.urgency.amber": "Past half SLA",
  "counsel.urgency.red": "SLA exceeded",
  "counsel.urgency.hours": "{hours} h of {sla} h",
  "counsel.pending": "{n} pending ({overdue} overdue)",
  "counsel.filterGestora": "Gestora",
  "counsel.filterUrgency": "Urgency",
  "counsel.allGestoras": "All gestoras",
  "counsel.allUrgencies": "All urgencies",
  "counsel.sections.mine": "My gestoras",
  "counsel.sections.pool": "New gestoras with no assigned lawyer",
  "counsel.sections.poolHint":
    "Any lawyer can pick up these reviews until one is assigned.",
  "counsel.sections.poolBadge": "No assigned lawyer",
  ...
  "notifications.daysAgo": "{d} days ago",
  ...
  // Funds & vehicles (SPVs) — /funds (015_vehicles.sql)
  "funds.title": "My funds",
  "funds.subtitle":
    "Your management company's funds and vehicles (SPVs) to request documents for.",
  "funds.new": "New fund",
  "funds.name": "Fund name",
  "funds.jurisdiction": "Jurisdiction",
  "funds.create": "Create fund",
  "funds.empty": "No funds yet. Create the first one.",
  "funds.vehicles": "Vehicles / SPVs",
  "funds.vehicleCount": "{count} vehicles",
  "funds.vehicleCountOne": "1 vehicle",
  "funds.noVehicles": "This fund has no vehicles yet.",
  ...
  "funds.delete": "Delete",
  "funds.confirmDelete": "Delete permanently?",
  "funds.confirmDeleteYes": "Yes, delete",
  "funds.vehicleType.spv": "SPV",
  "funds.vehicleType.feeder": "Feeder",
  "funds.vehicleType.coinvest": "Co-investment",
  "funds.vehicleType.holdco": "Holding",
  "funds.vehicleType.other": "Other",
};
